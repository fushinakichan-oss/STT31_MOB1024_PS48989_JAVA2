...
public class ImportedProduct extends Product {
	...
	public double finalPrice() {
		...
		//return basePrice + basePrice*importTaxRate+shippingFee;
		return super.finalPrice() + (super.getBasePrice() * this.importTaxRate)+this.shippingFee;
	}
	@Override
	public String toString() {
		return super.toString() + " ImportedProduct [importTaxRate=" + importTaxRate + ", shippingFee=" + shippingFee + ", finalPrice()="
				+ finalPrice() + "]";
	}
